...
if($row['role'] === 'admin') {
  ...
  exit();
        ...
        $_SESSION["gagal"] = "Akun anda tidak aktif, silahkan coba lagi";
      }
    }else{
          ...
          <div class="col-lg">
            <div class="container-tight">
              <div class="text-center mb-4">
                ...
                src="<?= base_url('assets/img/logo-small.svg') ?>" height="36" alt=""></a>
              </div>

<?php 
if (isset($_GET['pesan'])){
  if ($_GET['pesan'] = 'belum login'){
    $_SESSION['gagal'] = 'Mending Turu Woe';
  }else if ($_GET['pesan'] = 'tolak akses'){
