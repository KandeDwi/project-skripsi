                ...
                <div class="card text-center h-100">
                  ...
                  <div class="card-body">
                    ...
                    <?php } elseif(strtotime($waktu_sekarang) >= strtotime($jam_pulang) && mysqli_num_rows($ambil_data_presensi) == 0) { ?>
                      <i class="fa-regular fa-circle-xmark fa-4x text-danger"></i>
                      <h4 class="my-3">Silahkan Melakukan Presensi Masuk <br> Terlebih Dulu</h4>
                    <?php } else { ?>
...
<script>
  // waktu di card presensi masuk
  window.setTimeout("waktuMasuk()", 1000);

  function waktuMasuk(){
    const waktu = new Date();
    setTimeout("waktuMasuk()", 1000);
    namaBulan = ["Januari", "Februari", "Maret", "Äpril", "Mei", "Juni", "Juli", "Ägustus", "September", "Öktober", "November", "Desember"];
    ...
    document.getElementById("tahun_masuk").innerHTML = waktu.getYear();
...
// waktu di card presensi keluar
  ...
  document.getElementById("tahun_keluar").innerHTML = waktu.getYear();
